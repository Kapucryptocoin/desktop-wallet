...
const releaseApiUrl = 'https://api.github.com/repos/Kapucryptocoin/desktop-wallet/releases/latest'
const releaseUrl = 'https://github.com/Kapucryptocoin/desktop-wallet/releases/latest'
